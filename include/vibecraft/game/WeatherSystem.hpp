...
inline constexpr std::array<WeatherPreset, 5> kWeatherPattern{{
    {
        ...
        .rainIntensity = 0.0f,
        .sunOcclusion = 0.08f,
        .skyTintMultiplier = {1.00f, 1.00f, 1.00f},
        .horizonTintMultiplier = {1.00f, 1.00f, 1.00f},
        .cloudTint = {0.98f, 0.99f, 1.00f},
        .windDirectionXZ = {0.92f, 0.38f},
        .windSpeed = 2.0f,
    },
    {
        .type = WeatherType::Cloudy,
        .durationSeconds = 95.0f,
        .cloudCoverage = 0.55f,
        .rainIntensity = 0.0f,
        .sunOcclusion = 0.38f,
        .skyTintMultiplier = {0.90f, 0.93f, 0.97f},
        .horizonTintMultiplier = {0.93f, 0.94f, 0.96f},
        .cloudTint = {0.90f, 0.92f, 0.96f},
        .windDirectionXZ = {0.60f, 0.80f},
        .windSpeed = 3.0f,
    },
    {
        .type = WeatherType::Rain,
        .durationSeconds = 130.0f,
        .cloudCoverage = 0.88f,
        .rainIntensity = 1.0f,
        .sunOcclusion = 0.78f,
        .skyTintMultiplier = {0.63f, 0.70f, 0.80f},
        .horizonTintMultiplier = {0.72f, 0.76f, 0.83f},
        .cloudTint = {0.62f, 0.67f, 0.74f},
    ...
    },
    {
        ...
        .rainIntensity = 0.15f,
        .sunOcclusion = 0.44f,
        .skyTintMultiplier = {0.84f, 0.88f, 0.94f},
        .horizonTintMultiplier = {0.88f, 0.90f, 0.93f},
        .cloudTint = {0.84f, 0.87f, 0.92f},
        .windDirectionXZ = {-0.15f, 0.99f},
        .windSpeed = 3.6f,
    },
    {
        .type = WeatherType::Clear,
        ...
        .rainIntensity = 0.0f,
        .sunOcclusion = 0.04f,
        .skyTintMultiplier = {1.02f, 1.00f, 0.99f},
        .horizonTintMultiplier = {1.00f, 0.99f, 0.97f},
        .cloudTint = {1.00f, 0.98f, 0.96f},
        .windDirectionXZ = {-0.82f, 0.57f},
        .windSpeed = 1.8f,
    },
}};
