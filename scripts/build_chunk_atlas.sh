#!/usr/bin/env bash
# Packs selected materials into chunk_atlas.png (80x64, 16x16 tiles, 5x4 grid)
...
# Source order = tile indices 0..19 (row-major: 5 columns x 4 rows).
...
magick montage \
  "${TMP}/t00.png" "${TMP}/t01.png" "${TMP}/t02.png" "${TMP}/t03.png" "${TMP}/t04.png" \
  "${TMP}/t05.png" "${TMP}/t06.png" "${TMP}/t07.png" "${TMP}/t08.png" "${TMP}/t09.png" \
  "${TMP}/t10.png" "${TMP}/t11.png" "${TMP}/t12.png" "${TMP}/t13.png" "${TMP}/t14.png" \
  "${TMP}/t15.png" "${TMP}/t16.png" "${TMP}/t17.png" "${TMP}/t18.png" "${TMP}/t19.png" \
  -tile 5x4 -geometry 16x16+0+0 -background none "${OUT}/chunk_atlas.png"

magick "${OUT}/chunk_atlas.png" -depth 8 "BGRA:${OUT}/chunk_atlas.bgra"
rm -rf "${TMP}"
echo "Wrote ${OUT}/chunk_atlas.png and chunk_atlas.bgra (expected $((80*64*4)) bytes)"
